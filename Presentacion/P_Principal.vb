...
#Region "Metodos Privados"
    ...
    Private Sub _prIniciarTodo()
        ...
        L_prAbrirConexionBitacora(gs_Ip, gs_UsuarioSql, gs_ClaveSql, "BHDiconMatnovo")
...
#End Region
    ...
    Private Sub btVentContado_Click(sender As Object, e As EventArgs) Handles btVentContado.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F1_AsientoContableVentas
